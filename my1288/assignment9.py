...
if __name__ == '__main__':
	...
	# Make two lists to iterate through all five boroughs
	...
	for boro, name in zip(borough_names, filenames):
		...
		# Dataset for each borough
		boro_data   = SeparateBorough(boro, full_dataset)
		# Camis for each borough
		boro_camis = SeparateCamis(boro_data)
		# Performances for each borough
